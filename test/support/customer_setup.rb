...
class ActiveSupport::TestCase
  ...
  def setup_customers
    city_1 = FactoryGirl.create :city, name: "New York"
    city_2 = FactoryGirl.create :city, name: "California"
    city_3 = FactoryGirl.create :city, name: "Washington"
    
    FactoryGirl.create(:customer, 
      favorite_colors: ["red", "orange"], zip_code: "11101", age: 21,
      name: "Customer 1", email: "customer_1@gmail.com", phone: "1234", gender: "male",
      address: "Customer 1 Address", city: city_1, country: "USA",
      contacts: { 
    ...
    FactoryGirl.create(:customer, 
      ...
      address: "Customer 2 Address", city: city_2, country: "USA",
      contacts: { 
    ...
    FactoryGirl.create(:customer, 
      ...
      address: "Customer 3 Address", city: city_3, country: "USA",
      contacts: { 
